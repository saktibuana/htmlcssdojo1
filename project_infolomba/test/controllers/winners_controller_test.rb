...
class WinnersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create winner" do
    assert_difference("Winner.count") do
      post winners_url, params: { winner: { contest_id: @winner.contest_id, user_id: @winner.user_id } }
    end
  ...
  test "should update winner" do
    patch winner_url(@winner), params: { winner: { contest_id: @winner.contest_id, user_id: @winner.user_id } }
