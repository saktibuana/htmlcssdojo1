...
class ContestantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contestant" do
    assert_difference("Contestant.count") do
      post contestants_url, params: { contestant: { contest_id: @contestant.contest_id, user_id: @contestant.user_id } }
    end
  ...
  test "should update contestant" do
    patch contestant_url(@contestant), params: { contestant: { contest_id: @contestant.contest_id, user_id: @contestant.user_id } }
